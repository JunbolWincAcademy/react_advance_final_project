  ...
  return (
    <Flex direction="column" mt="1rem" align="center" width="100%" padding="4">
      ...
      <Link to={`/city/${cityName}/categories/categoryForm`}>
        <Button size="sm" mb="4" bg="red.600" color="white" _hover={{ bg: 'red', color: 'white' }}>
          Add a category
        </Button>
      </Link>
        ...
        {filteredCategories.length > 0 &&
          filteredCategories.map((categoryName) => {
            ...
            return categoryDetailsArray.map((category) => (
              <Box key={category.id} borderWidth="1px" borderRadius="lg" overflow="hidden" bg="red.800" align="center">
