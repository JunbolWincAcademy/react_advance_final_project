...
//           </Link>
//           <Button onClick={() => deleteActivity(cityName, activity.title)}>Delete this Activity</Button>
//         </ListItem>
//       ))}
//     </UnorderedList>
//   );
...
//       </Heading>
//       <Button>
//         <Link to={`/city/${cityName}/categories/${categoryName}/activities/:activityTitle/activityForm`}>Add an activity</Link>
//       </Button>
//       {<ActivityList />}
//     </div>
//   );
